...
namespace OrderService.Tests
{
    ...
    {
        private static readonly Product MotorSuper = new Product("Car Insurance", "Super", 2000);
        private static readonly Product MotorBasic = new Product("Car Insurance", "Basic", 1000);
